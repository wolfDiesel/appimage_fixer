...
from appimage_fixer.cli import main, check_appimaged_integration, list_installed_apps, check_versions, run_fixer, install_service, uninstall_service
...
class TestCLI:
    ...
    def test_check_appimaged_integration(self, mock_stdout, mock_get_integration):
        ...
        mock_integration.find_appimage_files.return_value = [Path('app1.AppImage'), Path('app2.AppImage'), Path('app3.AppImage')]
        mock_integration.find_desktop_files.return_value = [Path('app1.desktop'), Path('app2.desktop')]
    ...
    @patch('appimage_fixer.appimaged_integration.get_appimaged_integration')
    @patch('sys.stdout', new_callable=StringIO)
    def test_check_appimaged_integration_not_running(self, mock_stdout, mock_get_integration):
    ...
    def test_check_versions_with_data(self, mock_stdout, mock_fixer_class):
        ...
        mock_fixer.find_appimage_files.return_value = ['/test/app1.desktop', '/test/app2.desktop']
