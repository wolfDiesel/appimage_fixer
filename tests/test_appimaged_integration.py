...
from appimage_fixer.appimaged_integration import AppImageDIntegration, get_appimaged_integration
...
class TestAppImageDIntegration:
    ...
    def test_find_appimage_files(self, mock_access, mock_rglob, mock_exists):
        ...
        with patch.object(self.integration, 'get_appimage_directories', return_value=[Path("/test")]):
    ...
    def test_find_desktop_files(self, mock_rglob, mock_exists):
        ...
        with patch.object(self.integration, 'get_desktop_file_directories', return_value=[Path("/test")]):
